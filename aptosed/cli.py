...
from aptosed.chain.fees import estimate_fee
from aptosed.config import WalletConfig
from aptosed.services.sync import SyncEngine
...
def portfolio() -> None:
    ...
    click.echo(f"coin=APT total={total} fee_hint={fee}")
